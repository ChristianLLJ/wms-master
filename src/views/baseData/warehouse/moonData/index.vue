<template>
  <div>
    <el-row>
      ...
      <el-col :span="12">
        <div class="search">
          <el-select v-model="warehouseName" size="mini" clearable placeholder="请选择所属区域" @focus="func">
            <el-option v-for="item in warehouseOptions" :key="item.id" :label="item.warehouseName" :value="item.warehouseName" />
          </el-select>
          <el-select v-model="carType" size="mini" clearable placeholder="请选择月台类型">
    ...
    <el-dialog title="月台信息" :visible.sync="dialogFormVisible" class="showAll_dialog2">
      <el-form ref="form" :rules="rules" :model="form" size="mini" :inline="true" label-width="120px">
        ...
        <el-form-item label="结束作业时间1" prop="volumnCapacity">
    ...
    >
      ...
      <el-table-column label="所属区域" align="center" :show-overflow-tooltip="true" prop="carBrand" />
      <el-table-column label="收货标志" align="center" :show-overflow-tooltip="true" prop="isReceipt" />
      <el-table-column label="发货标志" align="center" :show-overflow-tooltip="true" prop="isDeliver" />
      <el-table-column label="开始作业时间1" align="center" :show-overflow-tooltip="true" prop="fromTimeFirst" />
      <el-table-column label="结束作业时间1" align="center" :show-overflow-tooltip="true" prop="toTimeFirst" />
      <el-table-column label="开始作业时间2" align="center" :show-overflow-tooltip="true" prop="fromTimeSecond" />
      <el-table-column label="结束作业时间2" align="center" :show-overflow-tooltip="true" prop="toTimeSecond" />
      <el-table-column
        width="200px"
        prop="action"
        label="操作"
...
import { delCar, addCar, updCar } from '@/api/user'
