<template>
  <div>
    ...
    >
      <el-table-column label="有计划收货-RF收箱记录" align="center">
        ...
        <el-table-column
          ...
          width="50"
        />
        <el-table-column label="有计划收货-RF收箱单号" :show-overflow-tooltip="true" prop="planId" />
...
export default {
  ...
  methods: {
    ...
    rowDbclick(row) {
      ...
      this.$router.push('/rfpackreceive')
    },
    typeFormat(row) {
