<template>
  <div>
    ...
    >
      <el-table-column label="有计划收货-RF收件记录" align="center">
        ...
        <el-table-column
          ...
          width="50"
        />
        <el-table-column label="有计划收货-RF收件单号" :show-overflow-tooltip="true" prop="planId" />
        ...
        <el-table-column v-if="false" prop="inboundState" :formatter="stateFormat" />
...
export default {
  ...
  methods: {
    ...
    rowDbclick(row) {
      ...
      this.$router.push('/rfpiecereceive')
    },
    getSummaries(param) {
      const { columns } = param
      const sums = []
