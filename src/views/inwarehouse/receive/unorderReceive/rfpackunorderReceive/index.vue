<template>
  <div>
    ...
    >
      <el-table-column label="无计划收货-RF收箱记录" align="center">
        ...
        <el-table-column
          ...
          width="50"
        />
        <el-table-column label="无计划收货-RF收箱单号" :show-overflow-tooltip="true" prop="planId" />
        <!-- <el-table-column label="入库计划单类型"  :show-overflow-tooltip="true" prop="inboundType" width="120px" :formatter="typeFormat" /> -->
        <!-- <el-table-column label="入库批次"  :show-overflow-tooltip="true" prop="inboundBatch" width="120px" /> -->
        ...
        <el-table-column label="收箱数量(个)" :show-overflow-tooltip="true" prop="receivedContainerNum" />
        <!-- <el-table-column prop="isAllChecke" label="是否全部质检"  :formatter="useFormat" />
              <el-table-column prop="isReceived" label="是否收货"  :formatter="useFormat" />
              <el-table-column label="是否收箱完成"  :show-overflow-tooltip="true" prop="isPackaged" :formatter="useFormat" />
              <el-table-column label="是否码盘完成"  :show-overflow-tooltip="true" prop="isStacked" :formatter="useFormat" /> -->
...
export default {
  ...
  methods: {
    ...
    rowDbclick(row) {
      ...
      this.$router.push('/unorderrfpack')
    },
    getSummaries(param) {
      const { columns } = param
      const sums = []
