<template>
  <div>
    ...
    <el-card :body-style="{padding:'0px'}" class="show_card">
      <e-desc title="采购订单-单头信息">
        <e-desc-item label="采购订单编号:">
          {{ form.orderId }}
        </e-desc-item>
    ...
    <div class="detailsTable">
      ...
      >
        <el-table-column label="采购订单-表细信息">
          ...
          <el-table-column label="预期包装数(个)" :show-overflow-tooltip="true" prop="predictContainerNum" />
...
export default {
  ...
  /* .el-table /deep/ .el-table__footer-wrapper tbody td.el-table__cell {
