<template>
  <div>
    ...
    >
      ...
      <el-table-column label="库区" sortable="custom" align="center" :show-overflow-tooltip="true" prop="areaName" />
      <el-table-column label="库区代码" sortable="custom" align="center" :show-overflow-tooltip="true" prop="areaCode" />
...
import { selectByAreaName } from '@/api/user'
export default {
