<template>
  <div>
    ...
    >
      ...
      <el-table-column label="商品" sortable="custom" align="center" :show-overflow-tooltip="true" prop="commodityName" />
      <el-table-column label="商品代码" sortable="custom" align="center" :show-overflow-tooltip="true" prop="commodityCode" />
...
import { selectByCommodityName } from '@/api/user'
export default {
