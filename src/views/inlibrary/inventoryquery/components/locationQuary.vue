<template>
  <div>
    ...
    >
      ...
      <el-table-column label="库位" sortable="custom" align="center" :show-overflow-tooltip="true" prop="locationName" />
      <el-table-column label="库位代码" sortable="custom" align="center" :show-overflow-tooltip="true" prop="locationCode" />
...
import { selectByLocationName } from '@/api/user'
export default {
