<template>
  <div>
    ...
    >
      ...
      <el-table-column label="生产厂家" sortable="custom" align="center" :show-overflow-tooltip="true" prop="productCompany" />
...
import { selectByProductCompany } from '@/api/user'
export default {
