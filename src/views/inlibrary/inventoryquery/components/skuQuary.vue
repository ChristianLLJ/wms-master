<template>
  <div>
    ...
    >
      ...
      <el-table-column label="商品sku" sortable="custom" align="center" :show-overflow-tooltip="true" prop="skuName" />
      <el-table-column label="sku代码" sortable="custom" align="center" :show-overflow-tooltip="true" prop="skuCode" />
...
import { selectBySkuName } from '@/api/user'
export default {
