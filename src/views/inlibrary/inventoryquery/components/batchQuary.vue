<template>
  <div>
    ...
    >
      ...
      <el-table-column label="生产批次" sortable="custom" align="center" :show-overflow-tooltip="true" prop="productBatch" />
...
import { selectByProductBatch } from '@/api/user'
export default {
