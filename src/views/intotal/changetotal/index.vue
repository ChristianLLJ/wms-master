<template>
  <div>
    ...
    <el-card :body-style="{padding:'0px'}" class="show_card">
      <e-desc title="库存调整-单头信息">
        <e-desc-item label="库存调整单号:">
          {{ form.changeCode }}
        </e-desc-item>
        <e-desc-item label="调整原因:">
          {{ form.changeReason }}
        </e-desc-item>
        <!-- <e-desc-item label="客户名称:">
          {{ form.customName }}
        </e-desc-item> -->
        <e-desc-item label="申请人:">
          {{ form.changePersonName }}
        </e-desc-item>
    ...
    <div class="detailsTable">
      ...
      >
        ...
        <el-table-column label="产品名称" align="center" :show-overflow-tooltip="true" prop="commodityName" />
        <el-table-column label="单位" align="center" :show-overflow-tooltip="true" prop="unit" />
        <el-table-column label="改变数量" align="center" :show-overflow-tooltip="true" prop="changeNum" />
        <el-table-column label="库位代码" align="center" :show-overflow-tooltip="true" prop="locationCode" />
        <!-- <el-table-column label="转移原因" align="center" :show-overflow-tooltip="true" prop="changeReason" /> -->
        ...
        <!-- <el-table-column label="包装数量" align="center" prop="commodityNum" /> -->
        <!-- <el-table-column label="改变净重" align="center" :show-overflow-tooltip="true" prop="changeNetWeight" /> -->
        <el-table-column label="改变毛重" align="center" :show-overflow-tooltip="true" prop="changeWeight" />
        <el-table-column label="改变体积" align="center" :show-overflow-tooltip="true" prop="changeVolumn" />
        <el-table-column label="改变金额" align="center" :show-overflow-tooltip="true" prop="changePrice" />
        <!-- <el-table-column label="改变时间" align="center" :show-overflow-tooltip="true" prop="changeTime">
          <template slot-scope="scope">{{ scope.row.changeTime| dateYMDHMSFormat }}</template>

        </el-table-column> -->
        <!-- <el-table-column label="生产厂家" align="center" prop="productCompany" />
        <el-table-column label="生产时间" align="center" prop="productTime" />
...
import { searchStockChangeDetailNum, searchStockChangeSelective, searchStockChangeDetailSelective, screenContainer, screenGoods } from '@/api/user'
...
export default {
  ...
  methods: {
    ...
    getList() {
      searchStockChangeSelective({
        searchDTO: {
          page: 1,
          num: 50
        },
        pojo: {
          changeCode: sessionStorage.getItem('changeCode')
        }}).then(response => {
    ...
    getListDetails(n1, n2) {
      ...
      searchStockChangeDetailSelective({ searchDTO,
        pojo: {
          changeId: sessionStorage.getItem('changeChildId')
        }}).then(response => {
